...
const Footer = () => {
  return (
        ...
        className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-600'>
            ...
            className='flex flex-wrap justify-between items-start gap-8 pb-6 border-border border-b'>
                <div>
                    <motion.img initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.5, delay: 0.3}}  
                    src={assets.logo} alt="logo" className='h-10 md:h-11' />
                ...
                className='flex flex-wrap justify-between w-1/2 gap-8'>
                    <div>
                        <p className='text-base font-medium text-gray-800 uppercase'>Links</p>
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-1.5'>
                            <li>123 sk. Basaksehir Istanbul</li>
                            <li>+1234566788</li>
            ...
            <motion.div initial={{opacity: 0, y:10}} whileInView={{opacity: 1, y:0}} transition={{duration: 0.6, delay: 0.6}}   
