              ...
              {cars.map((car, index)=>(
                <tr key={index} className='border-t border-border'>
                  ...
                  <td className='flex items-center p-3'>
                    <img src={car.isAvaliable ? assets.eye_close_icon : assets.eye_icon} alt="" className='cursor-pointer opacity-75'/>
                    <img src={assets.delete_icon} alt=""  className='cursor-pointer opacity-75'/>
                  </td>
