      ...
      <Title title='My Bookings' subTitle='View and manage all your bookings' align='left'/>
        ...
        <div>
          {bookings.map ((booking, index)=>
            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-border rounded-lg mt-5 first:mt-12'>
              ...
              <div className='md:col-span-2'>
                ...
                <div className='md:col-span-1 flex flex-col justify-between gap-6'>
                  <div className='text-sm text-gray-500 text-rigtt'>
                    <p>Total price</p>
